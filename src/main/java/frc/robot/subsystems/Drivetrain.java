...
import frc.robot.commands.JoystickOperation;
...
public class Drivetrain extends Subsystem 
{
	...
	public void turn(boolean left) {
		drive.arcadeDrive(0.0, 0.0);
		if(!left) {
			while(Robot.drivetrainSubsystem.getGyroAngle() != 0.90) {
				Robot.robotmap.FR.set(-0.75);
				Robot.robotmap.FL.set(0.75);
				Robot.robotmap.BR.set(-0.75);
				Robot.robotmap.BL.set(0.75);
			}
    ...
    public double getGyroAngle()
    {
    	...
    	return 0.0;//-fusionStatus.heading;
    }
